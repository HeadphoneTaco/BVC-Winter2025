...
public class BoxHitter : MonoBehaviour  
{
    ...
    private void OnCollisionEnter(Collision other)
    {
        ...
        //in Unity we use Debug.Log rather than Console.WriteLine.
        //This is because you are printing to Unity's debug rather than the Console.
        
        _audioSource?.Play(); 
        //the ? is a null check. If the _audioSource is null you will not get a value
    }
}
